SERVICES="quicksilver cosmoshub osmosis stargaze regen juno akash evmos kichain injective umee kujira crescent mars axelar terra2 sommelier composable dydx archway saga agoric cosmoshub-testnet stargaze-testnet evmos-testnet crescent-testnet regen-testnet terra2-testnet injective-testnet composable-testnet dydx-testnet osmosis-testnet"
