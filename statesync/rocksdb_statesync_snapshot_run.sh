# usage: ./rocksdb_statesync_snapshot_run.sh chain_name
# eg., ./rocksdb_statesync_snapshot_run.sh cosmoshub

chain_name="$1"

if [[ -z $chain_name ]]
then
  echo "No chain_name. usage eg., ./rocksdb_statesync_snapshot_run.sh cosmoshub"
  exit
fi
