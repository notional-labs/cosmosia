...
buid_chain () {
  ...
  if [ $( echo "${chain_name}" | egrep -c "^(umee|kujira|whitewhale|quicksilver|evmos|regen|juno|juno-archive-sub|omniflixhub|bandchain|cosmoshub|cosmoshub-archive-sub|kava)$" ) -ne 0 ]; then
