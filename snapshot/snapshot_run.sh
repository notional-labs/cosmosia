...
curl -Ls "https://raw.githubusercontent.com/notional-labs/cosmosia/65-add-umee-chain/snapshot/snapshot.nginx.conf" > /etc/nginx/nginx.conf
# mkdir -p /snapshot
/usr/sbin/nginx
...
curl -Ls "https://raw.githubusercontent.com/notional-labs/cosmosia/65-add-umee-chain/rpc/start_chain.sh" > $HOME/start_chain.sh
curl -Ls "https://raw.githubusercontent.com/notional-labs/cosmosia/65-add-umee-chain/snapshot/snapshot_download.sh" > $HOME/snapshot_download.sh
...
curl -Ls "https://raw.githubusercontent.com/notional-labs/cosmosia/65-add-umee-chain/snapshot/snapshot_cronjob.sh" > $HOME/snapshot_cronjob.sh
