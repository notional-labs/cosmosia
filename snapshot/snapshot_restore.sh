...
if [[ -z $git_repo ]]; then
  ...
  if [ $( echo "${chain_name}" | egrep -c "^(umee|kujira|whitewhale|quicksilver|regen|juno|juno-archive-sub|omniflixhub|cosmoshub|cosmoshub-archive-sub|bitcanna)$" ) -ne 0 ]; then
